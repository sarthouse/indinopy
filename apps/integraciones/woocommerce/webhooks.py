...
class WooCommerceWebhookView(View):
    """
    Endpoint de integración para recibir los webhooks de una tienda WooCommerce.
    Valida la firma HMAC-SHA256 y delega asincrónicamente a Celery según el tópico.
    """
    def post(self, request, tienda_id):
        ...
        # WooCommerce exige un HTTP 200 rápido (< 150ms) para no deshabilitar el Webhook
