...
Dispositivo fiduciario programable en el sistema informático que administra el flujo de fondos de una e-OP Federada. El sistema opera bajo **dos mecánicas jurídico-financieras distintas** que coexisten bajo este término:

* **Hito Cero (Adelanto Crediticio sobre Colateral — Factoring):** El FDI no administra fondos depositados por la marca, sino que adelanta capital propio con la e-OP homologada como colateral crediticio. La marca comitente asume el rol de **deudora a plazo** (30-60 días post-venta), sin haber depositado fondos previos en custodia. Su figura jurídica precisa es el *adelanto crediticio sobre colateral productivo* (factoring de orden de compra), encuadrable en la normativa de descuento de instrumentos de crédito comercial del BCRA —no en la de fideicomiso clásico.

* **Hitos de Avance y Hito Final (Fideicomiso de Administración con Liberación Condicionada):** El saldo adeudado por la marca queda retenido en una subcuenta fiduciaria cerrada del FDI. La marca **pierde la libre disponibilidad del dinero** a medida que cancela su deuda, y los fondos se van liberando automáticamente hacia la cuenta del tallerista conforme se verifican los hitos pactados mediante PoPW (geocercado + biometría RENAPER). Esta modalidad sí encuadra bajo la figura del Fideicomiso de Administración (Ley 24.441).

Esta distinción es relevante para la comunicación regulatoria ante el BCRA: el Hito Cero requiere normativa de factoring; los hitos posteriores requieren normativa de fideicomiso financiero de administración.

### **Hito Cero (Anticipo de Arranque Territorial)**
Primer desembolso financiero liberado a favor del tallerista (habitualmente entre el **35% y el 40%**, o hasta el **50% con Sello Buen Diseño**). Se acredita inmediatamente tras la convalidación de la orden por la MES (o al cumplirse las 48 horas de silencio positivo). Su fin es fondear el capital de trabajo inicial: compra de hilos, agujas, solventes, energía eléctrica y adelantos salariales para el sustento diario de los costureros. *Véase la entrada "Escrow Digital Atomizado" para la distinción jurídica entre este adelanto y los hitos posteriores.*
...
Último tramo del pago (habitualmente el **15% al 20%**) retenido en el FDI hasta que se verifiquen **dos condiciones acumulativas**: (1) la recepción definitiva del lote terminado y el control de calidad final; y (2) la constatación automática por ARCA de que el tallerista emitió el comprobante fiscal oficial correspondiente al servicio prestado. Hasta que ambas condiciones se cumplan, la e-OP se encuentra en estado de **Cierre Fiscal Pendiente** (ver entrada siguiente). Adicionalmente, permanece protegido durante una ventana de 48 horas hábiles para la eventual interposición de la tutela sindical ex-post.

### **Cierre Fiscal Pendiente (Estado `FISCAL_PENDING`)**
Estado intermedio en el ciclo de vida de la e-OP que se activa tras la entrega física del lote y que retiene el **Hito Final** (20%) en subcuenta fiduciaria del FDI hasta que el sistema constate, por interoperabilidad con la API de ARCA, la emisión del comprobante electrónico oficial por parte del tallerista (factura de Monotributo Productivo o del régimen general). Su propósito es garantizar que el ciclo de formalización sea completo: **no hay cobro final sin factura**. La retención no genera mora comercial; si el tallerista no emite el comprobante dentro del plazo razonable de espera, el sistema lo asiste con recordatorios automáticos antes de aplicar retención extendida. Una vez verificada la factura, el estado transiciona a `SETTLED` y el Hito Final se acredita junto con los puntos de Unidades de Crédito Productivo (UCP) correspondientes a la marca. Este mecanismo protege el cómputo del **Crédito Fiscal Presunto del 25%** y la deducción de Ganancias a los que tiene derecho la marca comitente por haber contratado mano de obra formalizada. *Para la especificación técnica de la máquina de estados finita (FSM) completa, ver el Paper del Protocolo e-OP, §4.2.*
